...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.82\textwidth]{enet2.pdf}    \caption{Comparing speed of screening methods for lasso model under different settings. Top row: computation time in second. Bottom row: relative computation time compared to SSR. First column: varying sparsity $s$. Second column: Varying number of grid points $L$. Third column: Varying range of grid $\lambda_{\min}/\lambda_{\max}$.}
    \label{fig:sim2}
\end{figure}
...
\midrule
$\alpha=1$ & 87.6 & 89.3 & 52.3  \\
$\alpha=0.95$ & 87.5 & 89.6 & 61.5  \\
$\alpha=0.9$ & 88.1 & 89.5 & 66.8  \\
$\alpha=0.8$ & 87.6 & 89.7 & 72.2  \\
$\alpha=0.6$ & 88.2 & 90.7 & 77.8 \\
$\alpha=0.4$ & 88.8 & 91.7 & 84.4  \\
$\alpha=0.2$ & 89.3 & 94.5 & 91.1  \\
